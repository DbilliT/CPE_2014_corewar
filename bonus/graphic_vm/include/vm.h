...
** Last update Sun Dec 14 01:47:11 2014 Pierre Bechade
*/
...
unsigned char	*class_champ2(unsigned char *my_tab, int champ_nbr, char *order, char *mapi);
...
void	fill_struct_champ4(LIST *tmp2, unsigned char *my_tab, int j, int champ_nbr, char *mapi);
